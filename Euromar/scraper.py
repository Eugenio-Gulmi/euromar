"""
Scraper Seafood Expo Global 2026 - VERSIÓN FINAL

Combina todas las técnicas probadas:
  - Perfil Chrome limpio al empezar
  - Load More automático con detección de captcha cada 5 iter
  - Recogida de URLs en TODOS los frames
  - Procesamiento en orden inverso (Z→A)
  - Pausas anti-bot aleatorias
  - Checkpoints cada 25 fichas
  - Resume automático si re-ejecutas

USO:
  python scraper_final.py

Salida: Expositores_Final.xlsx
"""
...
OUTPUT_FILE       = "Expositores_Final.xlsx"
...
REVERSE_ORDER     = True   # True = Z→A, False = A→Z
LIMIT             = None
# ================================
...
def build_driver():
    profile = os.path.join(os.getcwd(), "chrome_profile_final")
    if os.path.exists(profile):
        try:
            shutil.rmtree(profile)
            print(f"[OK] Perfil limpio")
        except Exception:
            pass
...
def main():
    ...
    try:
        ...
        wait_for_user("ENTER para cerrar")
